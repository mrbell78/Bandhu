import 'package:bondu/main_service/service_registration.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(child: Image.asset(
                          "assets/icons/welcome_logo.png", height: 110,)),
                        SizedBox(height: 20,),
                        ...
                        Container(
                          ...
                          child: ListView.builder(
                              ...
                              itemCount: provider.svList!.length > 0 ? provider
                                  .svList?.length : 0,
                                ...
                                return Column(
                                  children: [
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        // post form
                                        NavUtils.push(context,
                                            Services_Registration(serviceName: provider.svList?[index].name, serviceId:provider.svList?[index].id,));
                                      },
                                      child: Center(
                                        child: Container(
                                          width: MediaQuery
                                          ...
                                          decoration: BoxDecoration(
                                            borderRadius: BorderRadius.all(
                                                Radius.circular(25)),
                                            color: index%2==0?AppColors.banLightYellow:AppColors.banDarkOrange,
                                            // boxShadow: [
                                            //   BoxShadow(
                                            //     color: Colors.grey.withOpacity(0.3),
                                            //     spreadRadius: 2,
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Center(child: Container(
                                                    margin: EdgeInsets.only(
                                                        top: 5),
                                                    child: provider.svList?[index].imageUrl!=null?Image.network("${provider.svList?[index].imageUrl}"):Image.asset(
                                                        "assets/icons/ic-justice.png"))),
                                              ),
                                              Spacer(),
                                              Text("${provider.svList?[index].name}", style: TextStyle(
                        ...
                        //   onTap: () {
                        //     // post form
                        //     NavUtils.push(context, Services_Registration(
                        //       serviceName: "NCD", serviceId: 1,));
                        //   },
                        //   child: Center(
                        //     child: Container(
                        //       width: MediaQuery
                        ...
                        //                 margin: EdgeInsets.only(top: 5),
                        //                 child: Image.asset(
                        //                     "assets/icons/ic-caculator.png"))),
                        //           ),
                        //           Spacer(),
                        //           Text("SRHR", style: TextStyle(
                        //               color: AppColors.pureBlack,
                        //               fontSize: 14,
                        //               fontWeight: FontWeight.w600),),
                        //           SizedBox(width: 20,),
                        ...
                        //   onTap: () {
                        //     NavUtils.push(context, Services_Registration(
                        //       serviceName: "Mental Health", serviceId: 3,));
                        //   },
                        //   child: Center(
                        //     child: Container(
                        //       width: MediaQuery
                        ...
                        //                 margin: EdgeInsets.only(top: 5),
                        //                 child: Image.asset(
                        //                     "assets/icons/ic-website.png"))),
                        //           ),
                        //           Spacer(),
                        //           Text("Mental Health", style: TextStyle(
                        //               color: AppColors.pureBlack,
                        //               fontSize: 14,
                        //               fontWeight: FontWeight.w600),),
                        //           SizedBox(width: 20,),
                        ...
                        //   onTap: () {
                        //     NavUtils.push(context, Services_Registration(
                        //       serviceName: "Gender Base Violence",
                        //       serviceId: 4,));
                        //   },
                        //   child: Center(
                        //     child: Container(
                        ...
                        //                 margin: EdgeInsets.only(top: 5),
                        //                 child: Image.asset(
                        //                     "assets/icons/ic-gender-des.png"))),
                        //           ),
                        //           Spacer(),
                        //           Text("Gender Base Violence", style: TextStyle(
                        //               color: AppColors.pureBlack,
                        //               fontSize: 14,
                        //               fontWeight: FontWeight.w600),),
                        //           SizedBox(width: 20,),
