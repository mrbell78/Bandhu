...
@override
  ...
  //  _connectSocketReceiveEnd();
   ...
   //   Provider.of<ChatController>(context,listen: false).getMessage(widget.id);
   // });
                                  ...
                                  child: TextField(
                                    ...
                                    decoration: InputDecoration(
                                        ...
                                        suffixIcon: IconButton(onPressed: () async {
                                          ...
                                          await provider.sendMessage(custommerLogin?.data?.user?.id, widget.id, messageController.text.trim()).then((value) async {

                                           messageController.clear();
                                            await provider.getMessage(widget.id);
