...
import 'package:bondu/main_service/upload_profile_image.dart';
...
import '../main_service/upload_image.dart';
                              ...
                              children: [
                                ...
                                Positioned(
                                  ...
                                  child: GestureDetector(
                                    onTap: (){
                                      if(provider.profileInfoModel!=null){
                                        showDialog(
                                          context: context,
                                    ...
                                    GestureDetector(
                                        onTap: (){
                                          ...
                                          setState(() async {
                                            ...
                                            await provider.updateProfile(data, provider.profileInfoModel?.data?.id).then((value) {
                                              if(value==true){
                                                provider.getProfileInfo(provider.profileInfoModel?.data?.id);
                                                EasyLoading.dismiss();
                                              }
                                            });
                                          });
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                          onTap: (){
                                            setState(() {
                                              isEmailEdite=true;
                                              emailController.text=provider.profileInfoModel!.data?.email!??"";
                                            });
                                          },
                                          child: Image.asset("assets/icons/ic-edit-withcontainer.png",height: 30,width: 30,fit: BoxFit.cover,)),
                                      SizedBox(width: 8,),
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                          onTap: (){
                                            setState(() {
                                              isPhoneEdite=true;
                                              phoneController.text=provider.profileInfoModel!.data?.phone!??"";
                                            });
                                          },
                                          child: Image.asset("assets/icons/ic-edit-withcontainer.png",height: 30,width: 30,fit: BoxFit.cover,)),
                                      SizedBox(width: 8,),
